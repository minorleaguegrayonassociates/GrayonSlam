...
public:
    ...
    enum class ReceiptItemStates { GrandTotalHeader, GrandTotalFooter, GrandTotalThanks, GrandTotalDistance,
                                   HeaderTitle, HeaderDateTime, FooterTotal,FooterCustomerService, FooterPhone,
